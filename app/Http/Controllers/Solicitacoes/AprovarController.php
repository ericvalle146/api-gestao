...
use App\DTOs\Solicitacao\AprovarSolicitacaoDTO;
...
{
    public function __invoke(Solicitacao $solicitacao, AprovarSolicitacaoDTO $dto, AprovarSolicitacao $action, Request $request): ApiSuccessResponse
    {
