...
use App\Action\Solicitacao\Workflow\CancelarSolicitacao;
...
{
    public function __invoke(Solicitacao $solicitacao, CancelarSolicitacao $action, Request $request): ApiSuccessResponse
    {
